...
# Default setting
SCS1_ID                     = 5                 # SCServo#1 ID : 1
SCS2_ID                     = 6                 # SCServo#1 ID : 2
...
goal_position  = 1000               # SCServo will rotate between this value
if goal_position>=0:
    val=0b0000000000000000|abs(goal_position)
    SCS_MINIMUM_POSITION_VALUE=val
elif goal_position<0:
    val=0b1000000000000000|abs(goal_position)
    SCS_MINIMUM_POSITION_VALUE=val
    
goal_position  = 4000           # and this value (note that the SCServo would not move when the position value is out of movable range. Check e-manual about the range of the SCServo you use.)
if goal_position>=0:
    val=0b0000000000000000|abs(goal_position)
    SCS_MAXIMUM_POSITION_VALUE=val
elif goal_position<0:
    val=0b1000000000000000|abs(goal_position)
    SCS_MAXIMUM_POSITION_VALUE=val
